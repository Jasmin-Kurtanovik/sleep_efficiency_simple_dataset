"""Test the trained Transformer model and create per-user prediction plots."""
...
def main():
    """Run Transformer testing and save per-user plots."""
    set_seed(RANDOM_SEED)

    model_path = Path(MODEL_SAVE_PATH_TRANSFORMER)
    data_path = Path(DATA_PATH)
    output_dir = Path(EVALUATION_RESULTS_DIR_TRANSFORMER)
    ...
    results_path = output_dir / "evaluation_results_transformer.json"
